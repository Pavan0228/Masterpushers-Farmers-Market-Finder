        ...
        <div className="min-h-screen bg-gradient-to-b from-green-50 to-green-100">
            ...
            <nav className="bg-white shadow-md py-4 px-6">
                <div className="max-w-6xl mx-auto flex justify-between items-center">
                    ...
                    <div className="bg-green-600 text-white py-2 px-4 rounded-md font-medium">
                        Sign In
                    </div>
                </div>
            </nav>
            ...
            <div className="max-w-6xl mx-auto p-6">
                        ...
                        <div className="p-6 md:p-8">
                            ...
                            <div className="space-y-3 mb-6">
                                ...
                                <div className="flex space-x-3">
                                    ...
                                    <button className="flex-1 bg-gray-100 hover:bg-gray-200 text-gray-700 py-3 px-4 rounded-xl font-medium flex items-center justify-center transition-colors duration-200">
                            ...
                            <div className="mt-6 pt-6 border-t border-gray-100">
                                <h3 className="font-medium text-lg text-green-800 mb-3">
                                    Sold by
                                </h3>
                ...
                <div className="bg-white rounded-2xl shadow-lg p-6 mb-8">
                    ...
                    <div className="flex items-center mb-6">
                        <div className="text-3xl font-bold text-green-700 mr-2">
                            {product.rating}
                        </div>
                    ...
                    <div className="space-y-6">
                        <div className="border-b border-gray-100 pb-6">
                            ...
                            <p className="text-gray-600 mb-2">
                                These tomatoes are incredible. So much flavor
                        ...
                        <div className="border-b border-gray-100 pb-6">
                            ...
                            <p className="text-gray-600 mb-2">
                                I appreciate the sustainable farming practices.
                                The tomatoes had great texture and flavor.
                            </p>
                            <div className="text-sm text-gray-500">
                                Michael T. - March 2, 2025
                            </div>
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            ...
                            <p className="text-gray-600 text-sm">
                                Connecting local farmers with consumers since
                                2020. Supporting sustainable agriculture and
                                healthy communities.
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <p className="text-gray-600 text-sm mb-3">
                                Get updates on new products and upcoming market
                                events.
                            </p>
                            <div className="flex">
                                <input
